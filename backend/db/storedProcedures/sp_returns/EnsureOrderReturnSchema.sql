...
BEGIN
    ...
    -- Add PartialRefundAmount (seller-agreed amount for partial_refund resolution)
    IF NOT EXISTS (
        SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
    ...
    -- Add ProofUrl / ProofUploadedAt (seller uploads proof of manual bank transfer)
    IF NOT EXISTS (
        SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
    ...
    -- Add exchange shipping fields (seller ships replacement product)
    IF NOT EXISTS (
        SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
